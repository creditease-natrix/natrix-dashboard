<template>
    <div>
        <div id="nav">
            <span class="title">云拨测——告警编辑</span>
        ...
        class="demo-ruleForm">
            ...
            <div class="clear judge" v-if="showAggregation">
                ...
                <el-form-item label="监控点数量≥" class="fl" prop="aggregation_condition" v-if="this.ruleForm.aggregation_type == 'individuality'">
...
export default {
    ...
    methods: {
        ...
        editForm(){
            let alarm_id = this.$route.query.alarmId
            let data = {...this.ruleForm,alarm_id:alarm_id}
            this.$put({
        ...
        getMonitorList(){
            let protocol = this.ruleForm.protocol
            this.$get({
