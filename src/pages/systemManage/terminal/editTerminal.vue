    ...
    <div>
        ...
        <div class="optionBox clear">
            <ul class="primaryList">
                <li class="clearfix">
                    <span class="listLabel fl">端设备序列号：</span><span class="fl listOption">{{primaryInfo.sn}}</span>
                </li>
                <li class="clearfix">
                    <span class="listLabel fl">主机名称：</span><span class="fl listOption">{{primaryInfo.hostname}}</span>
                </li>
                <li class="clearfix">
                    <span class="listLabel fl">设备类型：</span><span class="fl listOption">{{primaryInfo.type}}</span>
                </li>
                <li class="clearfix">
            ...
            <ul class="orgList">
                <li class="clearfix">
                    <span class="listLabel fl">检测组织：</span>
                    <span class="fl listOption">
                        <strong class="org" v-for="(item1,index1) in primaryInfo.detect_orgs" :key="index1">{{item1.name}}</strong>
                    </span>
                </li>
                <li class="clearfix">
                    ...
                    <!-- <span class="fl listOption">
                        <strong class="org" v-for="(item1,index1) in primaryInfo.reg_orgs" :key="index1">{{item1.name}}</strong>
                    </span> -->
                </li>
                <li class="clearfix">
                    <span class="listLabel fl">检测网段：</span>
                    <span class="fl listOption">
                        <strong class="netIp" v-for="(item,index) in primaryInfo.segments" :key="index">
                            {{item}}
                        </strong>
                    </span>
                </li>
                ...
                <div class="organizationBox">
                    <ul class="organization">
                        <li>
                            <span>网段信息：</span>
                            <span>
                                <strong class="netIp" v-for="(item,index) in netWork" :key="index">
                                    {{item}}
                                </strong>
                            </span>
                        </li>
                        <li>
                            <span>地址信息：</span>
                            <span>
                                <strong class="netIp" v-for="(item,index) in address" :key="index">
                                    {{item}}
                                </strong>
                            </span>
                        </li>
        ...
        getOrganizationSummary(id){
            this.$get({
                ...
                if(res.data.code == 200){
                    ...
                    this.networks = res.data.info.networks
                }else{
                    this.$message({
                        type:"error",
