                ...
                <div class="taskListBox">
                    <ul>
                        <li class="listItem clear">
                            ...
                            <p class="fl labelContent taskName"><a href="javascript:void(0)" class="detailColor" @click="gotoTaskInfo">{{briefInfo.name}}</a></p>
                        </li>
                        <li class="listItem clear">
                        ...
                        <li class="listItem clear">
                            <div class="fl status"><span class="fl labelItem">任务状态：</span>{{$t(briefInfo.status)}}</div>
                            <div class="fl status"><span class="fl labelItem">监控频率：</span>{{briefInfo.frequency}}（分钟）</div>
                        </li>
                        <li class="listItem clear">
