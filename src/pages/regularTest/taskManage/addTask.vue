<template>
    <div>
        <div id="nav">
            <span class="title">云拨测——创建定时测任务</span>
        ...
        class="demo-ruleForm">
            ...
            <el-form-item label="监测频率" prop="frequency">
                <el-input v-model.number="ruleForm.frequency" type="number"></el-input>单位：（分）
            </el-form-item>
            <el-form-item label="终端配置" prop="terminal_switch">
                ...
                ></el-switch>
                <terminalConfig 
                v-show="ruleForm.terminal_switch" 
                ref="terminalConfig"></terminalConfig>
            </el-form-item>
    ...
    data() {
        ...
        return {
            ...
            rules:{
                ...
                frequency: [
                    { type:'number',required: true, message: '请输入监测频率', trigger: 'blur' },
    ...
    methods: {
        ...
        addTask(){
            ...
            let auth_info , header_info , body_info,terminal_configuration
                ...
                terminal_configuration = {
                    filter_type:"region",
                    filter_condition:[this.$refs.terminalConfig.province,this.$refs.terminalConfig.city],
                    terminal_select:this.$refs.terminalConfig.terminal === 1 ? false : true,
                ...
                if(this.ruleForm.protocol_switch){
                    switch(this.ruleForm.protocol_type){
                        case "PING":
                            ...
                            break;
                        case "HTTP":
                            auth_info = this.isObjEmpty(this.$refs.protocolConfig.authEditor.get())
                            header_info = this.isObjEmpty(this.$refs.protocolConfig.headerEditor.get())
                            body_info = this.isObjEmpty(this.$refs.protocolConfig.bodyEditor.get())
                            protocol_configuration = {
            ...
            console.log(terminal_configuration,"terminal_config")
            console.log(protocol_configuration,"protocol_config")
            ...
            let ruleForm = {
                ...
                protocol_configuration:this.ruleForm.protocol_switch ? protocol_configuration : null
            }
            console.log()
