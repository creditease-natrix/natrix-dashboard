    ...
    <div>
        <div id="nav">
            ...
            <el-breadcrumb separator-class="el-icon-arrow-right">
                ...
                <el-breadcrumb-item :to="{ path: '/taskList' }">定时测</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        ...
        <el-table
            ...
            label="状态">
                <template slot-scope="scope">
                    <span class="statusBtn successBk" v-if="scope.row.status == 'running'">{{$t(scope.row.status)}}</span>
                    <span class="statusBtn defaultBk" v-if="scope.row.status == 'expired'">{{$t(scope.row.status)}}</span>
                    <span class="statusBtn errorBk" v-if="scope.row.status == 'stoped'">{{$t(scope.row.status)}}</span>
                </template>
            </el-table-column>
            <el-table-column
            prop="effective_time"
            ...
            label="操作">
                <template slot-scope="scope">
                    ...
                    size="mini"
                    type="unfollowed"
                    @click="handleUnfollow(scope.$index, scope.row)">取关</el-button>
                    <el-button
                    v-show="scope.row.alertShow"
                    size="mini"
                    type="primary"
                    icon="el-icon-plus"
                    >告警</el-button>
